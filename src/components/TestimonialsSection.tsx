...
import { ChevronLeft, ChevronRight, ExternalLink, Star, ShieldCheck } from "lucide-react";
  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-8 lg:px-12 xl:px-14 max-w-[1550px] mx-auto scroll-mt-20" id="testimonials">
      ...
      <motion.div 
        ...
        className="rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-12 xl:p-16 bg-neutral-50 border border-neutral-200 shadow-sm relative overflow-hidden space-y-10"
      >
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10 min-h-[260px]"
          >
