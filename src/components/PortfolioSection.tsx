      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full max-w-full min-w-0">
        {filteredCaseStudies.map((study) => (
          <div
            ...
            className="group cursor-pointer rounded-3xl bg-white border border-neutral-200 hover:border-black transition-all duration-300 hover:-translate-y-1.5 overflow-hidden flex flex-col justify-between shadow-xs hover:shadow-xl w-full min-w-0"
          >
