      ...
      {project && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
          ...
          <motion.div
            ...
            className="bg-[#0f1115] text-white w-full max-w-4xl rounded-3xl xl:rounded-[2.5rem] p-6 sm:p-10 border border-white/15 shadow-2xl relative max-h-[92vh] overflow-y-auto space-y-8 z-10"
          >
            {/* Close button */}
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onClose}
              className="absolute top-6 right-6 p-2.5 rounded-full bg-white/10 border border-white/10 text-neutral-400 hover:text-white hover:bg-white/20 transition-colors z-10 cursor-pointer"
            ...
            <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <motion.button
                ...
                className="w-full sm:w-auto bg-[#c8ff00] text-black px-7 py-3 rounded-full font-extrabold uppercase tracking-wider text-xs flex items-center justify-center gap-2 hover:bg-[#dbff33] transition-colors shadow-xl cursor-pointer"
              >
